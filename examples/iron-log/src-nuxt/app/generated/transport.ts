...
export interface Transport {
  ...
  updateWorkoutSet(id: string, input: UpdateWorkoutSetInput): Promise<WorkoutSet>;
...
export function createHttpTransport(): Transport {
  return {
    ...
    async updateExercise(id: string, input: UpdateExerciseInput): Promise<Exercise> {
    ...
    async updateWorkout(id: string, input: UpdateWorkoutInput): Promise<Workout> {
    ...
    async createWorkoutSet(input: CreateWorkoutSetInput): Promise<WorkoutSet> {
      return httpPost<WorkoutSet>('/workout_sets', input);
    },
    async updateWorkoutSet(id: string, input: UpdateWorkoutSetInput): Promise<WorkoutSet> {
      return httpPut<WorkoutSet>(`/workout_sets/${encodeURIComponent(id)}`, input);
    },
