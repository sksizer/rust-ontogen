...
1. ### Add the MCP generator to your server config
   ...
   In your `build.rs`, add `ServerGenerator::Mcp` to the generators list:

   ```rust
   use ontogen::servers::config::{GeneratorConfig, ServerGenerator};

   // Inside your Config or ServersConfig:
   generators: vec![
       ...
       GeneratorConfig::Server(ServerGenerator::Mcp {
