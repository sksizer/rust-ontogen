...
2. **Root set.** The schema-known emitter computes a long-tail name list from the API surface — every type ident referenced by an endpoint's params or return that isn't an entity or generated DTO.
