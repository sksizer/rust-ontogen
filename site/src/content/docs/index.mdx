...
Each generator is standalone. You can run the full pipeline or pick individual stages. Upstream outputs enrich downstream generators but are never required.
